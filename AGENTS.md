...
**★2026-09-08(ADR-063)**: そのために **`STATE.md` は各節の最新 1 ブロックだけを持つ。**
**古いブロックは `logs/STATE-ARCHIVE.md` へ移し、人間の判断待ちは `logs/OPEN-ITEMS.md` に書く。**
**捨てるのではなく移す。**上限 400 行 / 60 KB(`code/tests/test_repo_hygiene.py` が見張る)。
